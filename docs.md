...
This module is an implementation of Wadler's `Pretty Printer`\_. As described in the paper, the pretty printer is an efficient algebra that supports multiple adaptable layouts according to the available space. 
